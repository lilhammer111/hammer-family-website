...
.article {
  display: grid;
  grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); /* 调整这里的300px以适合你的卡片宽度需求 */
  gap: 16px; /* 卡片间的间隔 */
  padding: 0; /* 去掉父容器的内边距确保卡片能顶到边框 */
  //margin: 0 auto; /* 中心对齐 */
  width: 100%; /* 或者一个具体的px值，根据实际需求调整 */
}
